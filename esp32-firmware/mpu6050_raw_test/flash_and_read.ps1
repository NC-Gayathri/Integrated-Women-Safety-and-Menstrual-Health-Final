...
Write-Host " FLASHING MPU6050 RAW TEST TO ESP32 (COM5)" -ForegroundColor Cyan
Write-Host "=======================================================" -ForegroundColor Cyan
...
$mergedBin = "c:\Users\arif\Integrated-Women-Safety-and-Menstrual-Health\WomenSafetyApp\esp32-firmware\mpu6050_raw_test\build\mpu6050_raw_test.ino.merged.bin"
...
try {
    ...
    Write-Host "--- Reading MPU6050 Raw Test Output (25 seconds) ---" -ForegroundColor Cyan
    Write-Host ">>> TEST NOW: Keep still, rotate slowly, tilt 90 deg, turn upside down <<<" -ForegroundColor Yellow
    Write-Host ""
